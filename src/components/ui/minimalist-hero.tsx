      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        <div className="relative order-1 md:order-2 flex justify-center items-center h-full">
          <motion.div
            ...
            className="absolute z-0 h-[270px] w-[270px] rounded-full bg-yellow-400/90 sm:h-[320px] sm:w-[320px] md:h-[380px] md:w-[380px] lg:h-[450px] lg:w-[450px]"
          ></motion.div>
          <motion.img
            src={imageSrc}
            alt={imageAlt}
            className="relative z-10 h-auto w-[20rem] object-cover md:w-[28rem] lg:w-[34rem]"
